    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IMongoDatabase>(c =>
            {
                ...
                return client.GetDatabase("CatalogDb");
            });

            services.AddSingleton<IMongoCollection<Category>>(c =>
            {
            ...
            {
                opt.Filters.Add(new AuthorizeFilter());//tüm controllara authorize ekler. global.
            });
